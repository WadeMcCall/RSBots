...
public class UserAreas {
    ...
    /// Draynor areas
    public static final Area DraynorMorganNPCHouse = new Area(3096, 3270, 3102, 3266);
    public static final Area DraynorUpstairsMorgan = new Area(3096, 3269, 3102, 3266, 1);
    ...
    public static final Area BlueMoonInn =  new Area(3218, 3402, 3227, 3394);
